            ...
            <tbody key={category._id} className="divide-y divide-gray-200">
              <tr>
                ...
                <td className="whitespace-nowrap px-4 py-2 gap-4 flex">
                  ...
                  >
                    <button onClick={() => openModal(category)} className="px-4 py-2">
                      Delete
                    </button>
                            ...
                            <div className="relative p-5">
                              <div className="text-center">
                                ...
                                <div>
                                  ...
                                  <div className="mt-2 text-sm text-gray-500 max-w-sm">Are you sure you want to delete this {categoryToDelete.name}?</div>
                                </div>
                              </div>
