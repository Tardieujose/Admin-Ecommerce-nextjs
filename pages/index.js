            ...
            <div className="sm:flex sm:items-center sm:justify-between">
              <div className="text-center sm:text-left">
                <h1 className="text-3xl font-bold text-gray-900 sm:text-3xl">
                  Welcome Back, <span className="text-bgWolf font-bold">{session.user.name}</span>
                </h1>
              ...
              <div className="mt-4 flex flex-col gap-4 sm:mt-0 sm:flex-row sm:items-center">
                ...
                {/* ACA PARA LINKEAR A MI PAGINA */}
                <Link href={'https://badwolf.vercel.app/'} target="_blank"
          ...
          <div className="h-32 rounded-lg bg-gray-200 flex items-center justify-center">
            ...
            >
              <div>
                ...
                <p className="text-2xl font-medium text-gray-900">ARS$ {formatPrice(totalPrice)}</p>
              </div>

              <div className="inline-flex gap-2 rounded bg-bgWolf p-1 text-colWolf">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-4 w-4"
                  fill="none"
                ...
                <span className="text-xs font-medium"> 66.81% </span>
              </div>
            </article>
          </div>
          <div className="h-32 rounded-lg bg-gray-200 flex items-center justify-center">
    ...
    >
      <div className="max-w-xl lg:max-w-3xl">
        ...
        <p className="mt-4 leading-relaxed text-colWolf max-w-sm">
          This website is only accessible to admins only.
        </p>
        <div className="col-span-6 sm:flex sm:items-center sm:gap-4 my-4 flex items-center justify-center">
          <button
            ...
            className="inline-block shrink-0 rounded-md border border-blue-600 bg-blue-600 px-12 py-3 text-sm font-bold text-white transition hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500"
          >
            Login With Google
          </button>
        </div>
